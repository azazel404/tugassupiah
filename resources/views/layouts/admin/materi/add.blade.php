			...
			<div class="col-md-6 col-12">
				...
				<div class="card">
					<div class="card-header">
						<span class="font-weight-light" style="font-size: 20px;">Tambah Materi</span> <button form="addMateri" type="submit" class="btn btn-primary float-right">Simpan</button>
					</div>
					<div class="card-body">
					@if(Session::has('error'))
						...
						<div class="row">
							<div class="col-md-12">
									<form id="addMateri" action="{{ route('admin.materi.create') }}" method="post" enctype="multipart/form-data">
									@csrf
